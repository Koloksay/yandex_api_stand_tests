...
#Функция возвращает копию словаря user_body из файла data.py и заменяет в нём значение
#"firstName" на то, что указано при обращении к функции в скобках
...
# Тест 7. Неспешное создание пользователя
# Параметр fisrtName содержит пробелы
def test_create_user_has_space_in_first_name_get_error_response():
    negative_assert_symbol("Человек и Ко")

# Тест 8. Неспешное создание пользователя
# Параметр fisrtName содержит спецсимволы
def test_create_user_has_special_symbol_in_first_name_get_error_response():
    negative_assert_symbol("№%@")

# Тест 9. Неспешное создание пользователя
...
# Тест 12. Ошибка
# Параметр fisrtName неверный тип данных (число)
